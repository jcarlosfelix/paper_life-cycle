...
introduce our algorithm inspired by the Life-Cycle of animal species in section
2, followed by our experimental configuration and results in section 3, we
analyze and describe some of our research findings in section 4, and we
