...
a population that evolves constantly. In this paper, we present a novel distributed nature-inspired algorithm for
...
processing workload, among several computers or running the algorithm as a
...
independently, eliminating waiting times between processes. This algorithm 
seeks to imitate the natural life cycle, where new individuals
...
containers by solving the OneMax problem comparing it with a basic (sequential) GA 
algorithm, where it showed favorable and promising results.
